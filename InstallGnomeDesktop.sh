...
apt install --yes firmware-linux firmware-linux-free firmware-linux-nonfree firmware-amd-graphics firmware-realtek firmware-atheros firmware-ath9k-htc gdm3 gnome-backgrounds gnome-bluetooth-sendto gnome-control-center gnome-keyring gnome-menus gnome-session gnome-settings-daemon gnome-shell gnome-shell-extensions gnome-user-docs orca gnome-sushi tecla adwaita-icon-theme glib-networking gsettings-desktop-schemas baobab evince gnome-calculator gnome-calendar gnome-characters gnome-connections gnome-console gnome-contacts gnome-disk-utility gnome-font-viewer gnome-logs gnome-software gnome-system-monitor gnome-text-editor gnome-weather loupe nautilus simple-scan gnome-snapshot totem yelp cups evolution-data-server fonts-cantarell gstreamer1.0-packagekit gstreamer1.0-plugins-base gstreamer1.0-plugins-good gvfs-backends gvfs-fuse libatk-adaptor libcanberra-pulse libglib2.0-bin libpam-gnome-keyring pipewire-audio system-config-printer-common system-config-printer-udev zenity firefox firefox-l10n-bg gnome-remote-desktop gnome-user-share network-manager rygel-playbin rygel-tracker low-memory-monitor avahi-daemon file-roller gnome-tweaks libgsf-bin libreoffice-calc libreoffice-impress libreoffice-gnome libreoffice-gtk3 libreoffice-writer rhythmbox seahorse  xdg-user-dirs-gtk cups-pk-helper gstreamer1.0-libav gstreamer1.0-plugins-ugly rhythmbox-plugins rhythmbox-plugin-cdrecorder totem-plugins network-manager-gnome hunspell-en-us hyphen-en-us hunspell-bg hyphen-bg libreoffice-l10n-bg libreoffice-help-en-us mythes-bg mythes-en-us mesa-utils vulkan-tools libvulkan1 libvulkan-dev mesa-vulkan-drivers vainfo libva-glx2 libva-dev libva-drm2 libva-x11-2 libva-wayland2 mesa-va-drivers vdpauinfo libvdpau1 libvdpau-dev mesa-vdpau-drivers ocl-icd-libopencl1 ocl-icd-opencl-dev mesa-opencl-icd clinfo libgl1-mesa-dri libglapi-mesa libgbm1 libwayland-egl1 libd3dadapter9-mesa libosmesa6 mesa-drm-shim ffmpeg gstreamer1.0-plugins-bad libavcodec-extra python3-opencv libopencv-dev gstreamer1.0-vaapi build-essential fonts-roboto fonts-font-awesome zip unzip unrar p7zip p7zip-full p7zip-rar git libayatana-appindicator3-1 ufw gufw flatpak gnome-software-plugin-flatpak hp-ppd foomatic-db-engine openprinting-ppds cups cups-browsed system-config-printer ipp-usb printer-driver-cups-pdf sane-utils pcscd libccid libpcsclite1 meson sassc bluez-tools bluetooth ruby ruby-dev zsh gnome-software-plugin-fwupd google-chrome-stable thunderbird thunderbird-l10n-bg nautilus-sendto birdtray;
