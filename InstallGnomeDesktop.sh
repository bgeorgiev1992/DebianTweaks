...
sudo fc-cache -v
sudo rm -rf ~/CascadiaCode CascadiaCode-2407.24.zip
...
## Install Microsoft Office 365 Fonts
git clone https://github.com/pjobson/Microsoft-365-Fonts.git
rm -rf Microsoft-365-Fonts/.git Microsoft-365-Fonts/README.md
sudo mv Microsoft-365-Fonts /usr/share/fonts/
sudo fc-cache -v
