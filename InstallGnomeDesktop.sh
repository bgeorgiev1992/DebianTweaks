...
sudo apt install --yes firmware-linux firmware-linux-free firmware-linux-nonfree firmware-amd-graphics firmware-realtek firmware-atheros firmware-ath9k-htc firmware-misc-nonfree firmware-iwlwifi adwaita-icon-theme at-spi2-core baobab dconf-cli dconf-gsettings-backend eog evince evolution-data-server fonts-inter-variable gdm3 gkbd-capplet glib-networking gnome-backgrounds gnome-bluetooth-sendto gnome-calculator gnome-characters gnome-contacts gnome-control-center gnome-disk-utility gnome-font-viewer gnome-keyring gnome-logs gnome-menus gnome-online-accounts gnome-session gnome-settings-daemon gnome-shell gnome-shell-extensions gnome-software gnome-sushi gnome-system-monitor gnome-console gnome-text-editor gnome-themes-extra gnome-user-docs gnome-user-share gsettings-desktop-schemas gstreamer1.0-packagekit gstreamer1.0-plugins-base gstreamer1.0-plugins-good gvfs-backends gvfs-fuse libatk-adaptor libcanberra-pulse libglib2.0-bin libpam-gnome-keyring libproxy1-plugin-gsettings libproxy1-plugin-webkit librsvg2-common nautilus pipewire-audio sound-theme-freedesktop system-config-printer-common system-config-printer-udev totem tracker xdg-desktop-portal-gnome yelp zenity firefox-esr fonts-cantarell libproxy1-plugin-networkmanager low-memory-monitor cheese file-roller gnome-calendar gnome-clocks gnome-color-manager gnome-maps gnome-photos gnome-weather orca rygel-playbin rygel-tracker simple-scan avahi-daemon gnome-tweaks libgsf-bin libreoffice-gnome libreoffice-writer libreoffice-calc libreoffice-impress rhythmbox seahorse xdg-user-dirs-gtk cups-pk-helper gstreamer1.0-libav gstreamer1.0-plugins-ugly rhythmbox-plugins totem-plugins firefox-esr-l10n-all mesa-utils mesa-utils-extra vulkan-tools vulkan-utils libvulkan1 libvulkan-dev mesa-vulkan-drivers vainfo libva-glx2 libva-egl1 libva-dev libva-drm2 libva-x11-2 libva-wayland2 mesa-va-drivers vdpauinfo libvdpau1 libvdpau-dev mesa-vdpau-drivers ocl-icd-libopencl1 ocl-icd-opencl-dev mesa-opencl-icd clinfo libgl1-mesa-dri libgl1-mesa-glx libglapi-mesa libegl1-mesa libgbm1 libwayland-egl1-mesa libd3dadapter9-mesa libosmesa6 mesa-drm-shim  ffmpeg gstreamer1.0-plugins-bad libavcodec-extra python3-opencv libopencv-dev gstreamer1.0-vaapi build-essential fonts-roboto fonts-font-awesome zip unzip unrar p7zip p7zip-full p7zip-rar gnome-shell-extension-appindicator libayatana-appindicator3-1 ufw gufw flatpak gnome-software-plugin-flatpak printer-driver-all hp-ppd foomatic-db-engine openprinting-ppds cups cups-browsed system-config-printer ipp-usb printer-driver-cups-pdf sane sane-utils pcscd libccid libpcsclite1 default-jdk meson sassc bluez-tools bluetooth ruby ruby-dev zsh gnome-software-plugin-fwupd gnome-remote-desktop;
